...
#region ICustomPluralizationMapping Members
        ...
        public void AddWord(string singular, string plural)
        {
            ...
            {
                throw new ArgumentException(string.Format("The {0} value '{1}' already exists in the user-defined dictionary.", "plural", plural), nameof(plural));
            }
            else if (this._userDictionary.ExistsInFirst(singular))
            {
                throw new ArgumentException(string.Format("The {0} value '{1}' already exists in the user-defined dictionary.", "singular", singular), nameof(singular));
            }
            else
            {
